(function() {
    ...
    function msNavigationServiceProvider() {
        ...
        var initInjector = angular.injector(['ng', 'ngCookies', 'ui.router']);
        // var initInjector1 = angular.injector(['ngCookies']);
        // var initInjector2 = angular.injector(['ui.router']);
        ...
        function saveItem(path, item) {
            ...
            // // var RoutePath = "http://localhost:7100/";
            ...
            //     // var l = _.where(moduledata, { Module: item.title });
            ...
            var parent = _findOrCreateParent(parts, item.order);
    ...
    function MsNavigationController($scope, msNavigationService) {
        ...
        if ($scope.root) {
            $scope.navigation = msNavigationService.getNavigationObject($scope.root);
        } else {

            $scope.navigation = msNavigationService.getNavigationObject();
        }
