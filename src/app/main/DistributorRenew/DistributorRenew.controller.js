(function () {
    ...
    angular
        ...
        .controller('DistributorRenewController', DistributorRenewController);

    /** @ngInject */
    function DistributorRenewController($http, $scope, $rootScope, $state, $q, $timeout, $mdToast, $document, $mdDialog, $cookieStore, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile) {
        ...
        $rootScope.CheckPageRights(($rootScope.state.current.ModuleName), function (response) {
            ...
            $scope.dtOptions = DTOptionsBuilder.newOptions().withOption('ajax', {
                url: $rootScope.RoutePath + "distributor/GetAllRenewData",
                data: function (d) {
        ...
        $scope.GetAllVehicleWithExpire = function (iduser, DeviceId) {
            $http.get($rootScope.RoutePath + 'distributor/GetAllVehicleExpirebyUser?idUser=' + iduser + '&idDistributor=' + $rootScope.UserId).then(function (data) {
                var data = data.data;
        ...
        $scope.Export = function () {
            ...
            window.location.href = $rootScope.RoutePath + "distributor/ExportRenewData?idApp=" + idApp + "&CurrentOffset=" + CurrentOffset + "&UserId=" + UserId + "&search=" + search + "&StartDate=" + StartDate + "&EndDate=" + EndDate + "&columns=" + columns + "&order=" + order + "&IsSuperAdmin=" + IsSuperAdmin;
