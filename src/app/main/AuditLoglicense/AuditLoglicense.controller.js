(function() {
    ...
    angular
        ...
        .controller('AuditLoglicenseController', AuditLoglicenseController);

    /** @ngInject */
    function AuditLoglicenseController($http, $scope, $rootScope, $state, $q, $timeout, $mdToast, $document, $mdDialog, $cookieStore, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile) {
        ...
        $scope.dtColumns = [
            ...
            DTColumnBuilder.newColumn('ExpiryDate').renderWith(Datefun),
            DTColumnBuilder.newColumn('OldExpiryDate').renderWith(Datefun),
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions().withOption('ajax', {
                url: $rootScope.RoutePath + "licence/GetAllLiacenceAuditlog",
                data: function(d) {
                    if ($scope.Search != "") {
