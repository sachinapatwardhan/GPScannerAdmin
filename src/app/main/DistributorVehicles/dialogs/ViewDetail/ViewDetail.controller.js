(function () {
    ...
    angular
        ...
        .controller('DistributorViewDetailCtrl', DistributorViewDetailCtrl);

    /** @ngInject */
    function DistributorViewDetailCtrl($http, $mdDialog, $cookieStore, $scope, ModalMethod, $rootScope, $mdToast, idVehicle, objVehicle) {
        var vm = this;
