(function () {
    ...
    angular
        ...
        .controller('DistributorVehiclesController', DistributorVehiclesController);

    /** @ngInject */
    function DistributorVehiclesController($http, $scope, $rootScope, $state, $q, $timeout, $mdToast, $document, $mdDialog, $cookieStore, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile) {
        ...
        $scope.ShowModal = function (ev, device, Name, IsOnline) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/main/DistributorVehicles/dialogs/Location/Location.html',
        ...
        $scope.OpenViewModel = function (e, idVehicle) {
            ...
            $mdDialog.show({
                controller: 'DistributorViewDetailCtrl',
                controllerAs: 'vm',
                templateUrl: 'app/main/DistributorVehicles/dialogs/ViewDetail/ViewDetail.html',
                parent: angular.element($document.body),
