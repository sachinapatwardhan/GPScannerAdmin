(function () {
    ...
    function OrderServiceController($http, $scope, $rootScope, $state, $mdToast, $document, $mdDialog, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile) {
        ...
        $scope.OpenUpdateDeviceModal = function (ev, id) {
            var objData = _.findWhere($scope.lstdata, { id: id });
            $mdDialog.show({
        ...
        $scope.RenewOrderService = function (id) {
            ...
            $http.get($rootScope.RoutePath + "orderservice/RenewOrderService", { params: params }).then(function (resRenew) {
        ...
        $scope.ChangeStatus = function (id) {
            ...
            $http.get($rootScope.RoutePath + "orderservice/ChangeStatus", { params: params }).then(function (data) {
