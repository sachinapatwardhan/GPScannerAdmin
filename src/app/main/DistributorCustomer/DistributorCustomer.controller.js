(function() {
    ...
    angular
        ...
        .controller('DistributorCustomerController', DistributorCustomerController);

    /** @ngInject */
    function DistributorCustomerController($http, $scope, $rootScope, $state, $q, $timeout, $mdToast, $document, $mdDialog, $cookieStore, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile) {
        // console.log("Hell..");
        var vm = this;
        ...
        $scope.ChangePassword = function(ev, id) {
            ...
            $mdDialog.show({
                skipHide: true,
                controller: 'DistributorChangePasswordCustomerController',
                controllerAs: 'vm',
                templateUrl: 'app/main/DistributorCustomer/dialogs/ChangePassword/ChangePassword.html',
        ...
        $scope.ResetPassword = function(ev, id) {
            ...
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/main/DistributorCustomer/dialogs/PasswordConfirmation/PasswordConfirmation.html',
                parent: angular.element($document.body),
                targetEvent: ev,
                clickOutsideToClose: true,
                locals: {
        ...
        $scope.ShowDeviceModal = function(ev, id) {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/main/DistributorCustomer/dialogs/DeviceModel/DeviceModel.html',
                parent: angular.element(document.body),
                targetEvent: ev,
                clickOutsideToClose: true,
                locals: {
