    ...
    function ProductController($filter, $http, $scope, $rootScope, $state, $mdToast, $document, $mdDialog, $stateParams, DTOptionsBuilder, DTColumnDefBuilder, $cookieStore, DTColumnBuilder, $compile, $element, $timeout) {
        ...
        $rootScope.CheckPageRights(($rootScope.state.current.ModuleName), function(response) {
            ...
            vm.dtColumnDefs = [
                ...
                DTColumnBuilder.newColumn('ProductTypeId').notSortable().renderWith(TypeHtml),
                DTColumnBuilder.newColumn('Name'),
                DTColumnBuilder.newColumn('Sku').withOption('responsivePriority', 1),
                DTColumnBuilder.newColumn('Price').renderWith(DecimalHtml),
        ...
        vm.dt3ColumnDefs = [
            ...
            DTColumnDefBuilder.newColumnDef(2).notSortable().withOption('class', 'text-center'),
        ];
