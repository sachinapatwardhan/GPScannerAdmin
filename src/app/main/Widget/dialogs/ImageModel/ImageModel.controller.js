(function() {
    ...
    angular
        .module('app.Widget')
        .controller('ImageModelWidgetController', ImageModelWidgetController);

    /** @ngInject */
    function ImageModelWidgetController($http, $mdDialog, $scope, objMedia, Tasks, event, MediaVM,$rootScope) {
        var vm = this;
