        ...
        $http.get($rootScope.RoutePath + "userPermission/GetAllPageRights").then(function(data) {
          if (data.data.success == true) {
            ...
            if (lstTrackers.length > 0) {
              msNavigationService.saveItem('PetDevice', {
                title: 'Trackers',
                state: 'app.PetDevice',
            ...
            if (lstOwnerCustomer.length > 0) {
              msNavigationService.saveItem('Gpsina.Customer', {
                title: 'Customer',
            ...
            if (lstownerbike.length > 0) {
              msNavigationService.saveItem('Gpsina.ownerbike', {
                title: 'Vehicle',
                state: 'app.ownerbike',
            ...
            console.log(gps)
            if (gps.length > 0) {
              msNavigationService.saveItem('Gpsina.Gps', {
                title: 'Gps',
                state: 'app.gps',
